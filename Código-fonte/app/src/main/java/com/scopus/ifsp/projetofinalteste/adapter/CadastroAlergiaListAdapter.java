 ...
 * @author Denis Magno
 */
public class CadastroAlergiaListAdapter extends BaseAdapter {
    private final List<Alergia> alergias;
    private final Activity act;

    public CadastroAlergiaListAdapter(List<Alergia> alergias, Activity act) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View view = act.getLayoutInflater().inflate(R.layout.item_cadastro_alergia, parent, false);
