 ...
 * @author Denis Magno
 */
public class CadastroRemedioListAdapter extends BaseAdapter {
    private final List<Remedio> remedios;
    private final Activity act;

    public CadastroRemedioListAdapter(List<Remedio> remedios, Activity act) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View view = act.getLayoutInflater().inflate(R.layout.item_cadastro_remedio, parent, false);
