...
public class Idoso implements Serializable {
    ...
    public List<Remedio> getRemedios() {
        if (remedios == null) {
            ...
            List<Remedio> remediosNew = targetDao._queryIdoso_Remedios(id);
            synchronized (this) {
                if (remedios == null) {
                    remedios = remediosNew;
                }
            }
        }
        return remedios;
    ...
    /** Resets a to-many relationship, making the next get call to query for a fresh result. */
    @Generated(hash = 1590029381)
    public synchronized void resetRemedios() {
        remedios = null;
    }
