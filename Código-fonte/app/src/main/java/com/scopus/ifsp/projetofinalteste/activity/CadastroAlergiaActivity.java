...
import com.scopus.ifsp.projetofinalteste.adapter.CadastroAlergiaListAdapter;
    ...
    public void iniciarEventos() {
        ...
        this.btnProximo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CadastroAlergiaActivity.this, CadastroContatoEmergenciaActivity.class);
