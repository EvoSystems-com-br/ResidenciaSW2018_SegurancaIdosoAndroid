 ...
 * @author Denis Magno
 */
public class CadastroMedicamentoListAdapter extends BaseAdapter {
    private final List<Medicamento> medicamentos;
    private final Activity act;

    public CadastroMedicamentoListAdapter(List<Medicamento> medicamentos, Activity act) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View view = act.getLayoutInflater().inflate(R.layout.item_cadastro_medicamento, parent, false);
